...
public class TrainingProperties {
    ...
    public static final int NR_BENCHMARK_GAMES = 200;
    public static final int NR_FITNESS_GAMES = 200;
    ...
    public static final double GENOME_MUTATION_PROBABILITY = 0.6;
    public static final double GEN_MUTATION_PROBABILITY = 0.2;
    public static final int MUTATION_RANGE = 10;
}
